...
RUN pip install --upgrade pip setuptools pytest pytest-snapshot substrait==0.8.0 pyarrow protobuf duckdb filelock datafusion==32.0.0 ibis_substrait ibis_framework==7.0.0 JPype1
