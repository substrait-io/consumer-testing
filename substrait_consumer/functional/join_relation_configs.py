...
JOIN_RELATION_TESTS = (
    {
        ...
        "local_files": {},
        "named_tables": {"customer": "customer_small.parquet", "orders": "orders_small.parquet"},
    ...
    },
    {
        ...
        "local_files": {},
        "named_tables": {"orders": "orders_small.parquet", "lineitem": "lineitem_small.parquet"},
    ...
    },
    {
        ...
        "local_files": {},
        "named_tables": {"customer": "customer_small.parquet", "customer": "customer_small.parquet"},
