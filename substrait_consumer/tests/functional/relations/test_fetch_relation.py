...
class TestFetchRelation:
    ...
    def test_producer_fetch_relations(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "fetch"
    ...
    def test_consumer_fetch_relations(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "fetch" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "fetch"
