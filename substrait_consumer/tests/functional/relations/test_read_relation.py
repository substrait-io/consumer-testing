...
class TestReadRelation:
    ...
    def test_producer_read_relations(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "read"
    ...
    def test_consumer_read_relations(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "read" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "read"
