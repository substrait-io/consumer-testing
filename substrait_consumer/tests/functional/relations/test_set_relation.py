...
class TestSetRelation:
    ...
    def test_producer_set_relations(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "set"
    ...
    def test_consumer_set_relations(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "set" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "set"
