...
class TestJoinRelation:
    ...
    def test_producer_join_relations(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "join"
    ...
    def test_consumer_join_relations(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "join" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "join"
