...
from substrait_consumer.functional.sort_relation_configs import (
    SORT_RELATION_TESTS)
...
class TestSortRelation:
    ...
    def test_producer_sort_relations(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "sort"
    ...
    def test_consumer_sort_relations(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "sort" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "sort"
