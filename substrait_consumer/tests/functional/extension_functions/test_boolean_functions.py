...
class TestBooleanFunctions:
    ...
    def test_producer_boolean_functions(
        ...
        snapshot.snapshot_dir = SNAPSHOT_DIR / "producer" / "boolean"
    ...
    def test_consumer_boolean_functions(
        ...
        plan_path = SNAPSHOT_DIR / "producer" / "boolean" / f"{test_name}_plan.json"
        snapshot.snapshot_dir = SNAPSHOT_DIR / "consumer" / "boolean"
