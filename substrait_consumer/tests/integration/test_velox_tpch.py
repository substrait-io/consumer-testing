...
from substrait_consumer.consumers import AceroConsumer, DuckDBConsumer, VeloxConsumer
...
class TestVeloxConsumer:
    """
    Test Class for testing Substrait using Velox as a consumer.
    """
    ...
    def setup_teardown_class(request):
        ...
        cls.velox_consumer = VeloxConsumer()
    ...
    def test_isthmus_substrait_plan(
        ...
        subtrait_query_result_tb = self.velox_consumer.run_substrait_query(
            substrait_query
        )
        print(subtrait_query_result_tb)
